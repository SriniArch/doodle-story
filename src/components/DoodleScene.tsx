...
function DoodleProp({ object }: { object: ObjectFrame }) {
  ...
  if (name === "coffee") return <g className="prop prop-coffee" data-fx={fx === "spill" ? "spill" : "none"} opacity={object.opacity} transform={`translate(${x} ${y})`}><g className="coffee-cup"><path d="M-14-12h27v27h-27zM13-6h7a8 8 0 0 1 0 16h-7" /></g><path className="coffee-steam steam-a" d="M-7-19c-5-7 5-8 0-15" /><path className="coffee-steam steam-b" d="M5-19c-5-7 5-8 0-15" /><g className="coffee-drops"><path d="M8 18c2 8 1 16-3 22" /><path d="M16 16c3 9 4 16 1 24" /><path d="M22 12c4 7 6 14 4 20" /></g>{fx === "spill" ? <g className="coffee-miss"><path d="M-10 20c-2 7-1 14 2 18" /><path d="M-18 14c-3 8-2 14 1 20" /></g> : null}</g>;
  ...
  if (name === "car") return <g className="prop prop-car" opacity={object.opacity} transform={`translate(${x} ${y})`}><path d="M-38 4l7-22h46l18 22v18h-71zM-25-18l10-13h23l12 13M-22 4h15m20 0h15" /><g className="car-wheel" transform="translate(-22 22)"><circle r="8" /><path d="M0-6V6M-6 0h12" /></g><g className="car-wheel" transform="translate(22 22)"><circle r="8" /><path d="M0-6V6M-6 0h12" /></g></g>;
